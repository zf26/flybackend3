...
public class SysDeptController extends BaseController
{
     ...
     * 根据部门ID查找子部门
     * */
    @GetMapping("/getChildByDeptId")
    public AjaxResult getChildByDeptId(@RequestParam("deptId") Long deptId){
        // 不存在子部门
        if (!deptService.hasChildByDeptId(deptId))
        {
            return AjaxResult.success();
        }
        return AjaxResult.success(deptService.selectChildrenDeptById(deptId));
    }
}
